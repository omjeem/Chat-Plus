...
import com.example.chatplus.ProfileImageViewActivity;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.findViewById(R.id.userNameList).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.itemView.findViewById(R.id.profile_image).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, ProfileImageViewActivity.class);
                intent.putExtra("ReciverId",users.getUserId());
                context.startActivity(intent);
            }
        });
